		...
		<div class="sidebar sidebar-dark sidebar-main sidebar-expand-md">
			...
			<div class="sidebar-content">
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								<li class="nav-item"><a href="form_inputs.html" class="nav-link">Editar</a></li>
						...
						<li class="nav-item"><a href="form_input_groups.html" class="nav-link">Lista de empleados</a></li>
				...
				<!-- Components -->
					...
					<li class="nav-item"><a href="components_modals.html" class="nav-link">Opciones de seleccion</a></li>
						...
						<li class="nav-item nav-item-submenu">
								<li class="nav-item"><a href="extension_image_cropper.html" class="nav-link">Agregar y enlistar</a></li>
					...
					<li class="nav-item nav-item-menu">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Extensions">
								<li class="nav-item"><a href="general_feed.html" class="nav-link">Datos sobre las vacaciones</a></li>
